...
class AliceAgent(DemoAgent):
    ...
    async def handle_present_proof(self, message):
        print("present proof received,", message)
        state = message["state"]
        ...
        if state == "request_received":
            ...
            print("post cred sort")

            ##ok so any credentials that arent in the wallet just filledin by the controller code as appropirate
